...
public partial class Form2 : Form
{
    ...
    public Form2()
    {
        ...
        _enemyFourLocation = enemy4.Location;
    ...
    private readonly Point _enemyFourLocation;
    ...
    private void globalTimer_Elapsed(object sender, ElapsedEventArgs e)
    {
        ...
        foreach (Control x in Controls)
        {
            ...
            {
                if (mario.HandleCollisions2(x, this)) isOnTemporaryGround = true;
    ...
    private void MoveEnemies()
    {
        ...
        if (_enemy4Left)
        {
            enemy4.Left -= _enemySpeed4;
            if (enemy4.Left < movingGhostArea.Left)
            {
                _enemy4Left = false;
            }
        }
        ...
        {
            enemy4.Left += _enemySpeed4;
            if (enemy4.Left + enemy4.Width > movingGhostArea.Left + movingGhostArea.Width)
            {
                _enemy4Left = true;
            }
        }
    ...
    private void AnimEnemies()
    {
        if (_enemy2Left)
        {
            if (!_enemy2AnimLeft)
            {
                ...
                enemy2.Image = Properties.Resources.bones_walking;
            }
        }
        else
        {
            if (!_enemy2AnimRight)
            {
                ...
                enemy2.Image = Properties.Resources.bones_walking_right;
            }
        }
        ...
        if (_enemy3Left)
        {
            if (!_enemy3AnimLeft)
            {
                ...
                enemy3.Image = Properties.Resources.bones_walking;
            }
        }
        else
        {
            if (!_enemy3AnimRight)
            {
                ...
                enemy3.Image = Properties.Resources.bones_walking_right;
            }
        }
        ...
        if (_enemy4Left)
        {
            if (!_enemy4AnimLeft)
            {
                _enemy4AnimLeft = true;
                _enemy4AnimRight = false;
                enemy4.Image = Properties.Resources.ghost_walking;
            }
        }
        else
        {
            if (!_enemy4AnimRight)
            {
                _enemy4AnimLeft = false;
                _enemy4AnimRight = true;
                enemy4.Image = Properties.Resources.ghost_walking_right;
            }
        }
    }
